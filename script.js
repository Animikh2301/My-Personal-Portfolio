...
ScrollReveal().reveal('.home-img, .services-container, .project-box, .contact form, .skills-container', { origin: 'bottom' });
...
const typed = new Typed('.multiple-text', {
    strings: ['Full Stack Developer','Final Year Student','Tech Enthusiast'],
    typeSpeed: 100,
    backSpeed: 100,
    backDelay: 2000,
    loop: true
